        ...
        <article class="bg-white rounded-2xl border border-slate-200/80 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between group"> 
            <div> 
                <a href="${blog.link}" class="block"> 
                    ...
                    <div class="rounded-t-2xl overflow-hidden aspect-video w-full bg-slate-100 flex items-center justify-center"> 
                ...
                <div class="p-5 sm:p-6 space-y-3"> 
                    ...
                    <h3 class="text-base sm:text-lg font-bold text-[#0F172A] group-hover:text-[#DC2626] transition-colors leading-snug"> 
                        <a href="${blog.link}">${blog.title}</a> 
                    </h3> 
                    <p class="text-slate-600 text-sm line-clamp-3 leading-relaxed">${blog.desc}</p> 
                </div> 
            </div> 
            <div class="px-5 sm:px-6 pb-5 sm:pb-6 pt-2 border-t border-slate-100/80 flex items-center justify-between text-xs font-bold mt-auto"> 
